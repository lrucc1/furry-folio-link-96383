...
<body style="background-color: #f8fafa; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', sans-serif; margin: 0; padding: 40px 0;">
  <div style="background-color: #ffffff; margin: 0 auto; padding: 40px 20px; max-width: 560px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05);">
    ...
    <h1 style="color: #1a1a1a; font-size: 24px; font-weight: 600; text-align: center; margin: 0 0 16px;">Log In to PetLinkID</h1>
    
    <p style="color: #1a1a1a; font-size: 16px; line-height: 24px; margin: 16px 0;">
      Click the button below to securely log in to your PetLinkID account. No password needed!
    </p>

    <a href="${magicLinkUrl}" style="background-color: #2E9B8D; border-radius: 8px; color: #ffffff; display: block; font-size: 16px; font-weight: 600; text-align: center; text-decoration: none; padding: 14px 24px; margin: 24px auto; width: fit-content;">
      Log In to PetLinkID
    </a>
    ...
    <p style="color: #2E9B8D; font-size: 14px; word-break: break-all; text-decoration: underline;">
      <a href="${magicLinkUrl}" style="color: #2E9B8D; text-decoration: underline;">${magicLinkUrl}</a>
    </p>
