...
import { FormSection, FormRow, FormToggleRow } from '@/components/ios/FormSection';
...
export default function IOSAddPet() {
  ...
  const handleSubmit = async () => {
    ...
    if (!validation.success) {
      ...
      toast.error(first?.message || 'Please fix the form');
      return;
    }
    ...
    <IOSPageLayout title="Add Pet" headerRight={headerLeft}>
      <div className="pb-8">
        ...
        <FormSection title="Basic Information">
          <FormRow label="Pet Name" required>
            <Input
              value={formData.name}
          ...
          <FormRow label="Species" required>
        ...
        <FormSection title="Microchip & Registry">
          <FormRow label="Microchip Number">
            <Input
          ...
          <FormRow label="Registry Website">
            <Input
