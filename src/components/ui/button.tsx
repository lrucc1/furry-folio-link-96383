...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium leading-none ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 [&_svg]:block",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white shadow-glow hover:shadow-strong hover:brightness-110 transition-spring font-semibold",
        ...
        accent: "bg-gradient-accent text-accent-foreground shadow-medium hover:shadow-strong hover:brightness-110 transition-spring",
